...
angular.module("ngJobportal",["ui.router","ngAnimate","ui.bootstrap"]);
"use strict";angular.module("ngJobportal").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/"),e.state("index",{url:"/",templateUrl:"templates/main.html"}).state("profile",{url:"/profile/:id",templateUrl:"templates/profile.html"})}]);
angular.module("ngJobportal").factory("restService",["$http","$q",function(e,t){function r(e){return e.url||c+e}function n(){return{headers:{"Content-Type":"application/json"}}}var o="localhost",u="8088",c="http://"+o+":"+u+"/att/reports/";return{get:function(n,o){var u=t.defer();return e.get(r(n),o).success(function(e){u.resolve(e)}).error(function(e,t,r,n){u.reject()}),u.promise},post:function(o,u){var c=t.defer(),i=n();return e.post(r(o),u,i).then(function(e){c.resolve(e)},function(e){c.reject()}),c.promise},put:function(o,u){var c=t.defer(),i=n();return e.put(r(o),u,i).then(function(e){c.resolve(e)},function(e){c.reject()}),c.promise},load:function(t,r,n){e.get(t).success(r).error(function(e,t,r,n){})},getServerAddress:function(){return o}}}]);